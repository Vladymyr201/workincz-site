...
class DemoLoginSystem {
  ...
  createDemoLoginModal() {
    ...
    const demoButton = document.querySelector('button:contains("🚀 Демо-вход")') || 
                      Array.from(document.querySelectorAll('button')).find(btn => btn.textContent.includes('🚀 Демо-вход'));
